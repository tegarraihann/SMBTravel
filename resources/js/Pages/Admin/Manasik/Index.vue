            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ getActiveSessionsCount() }}
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ getTotalParticipantsCount() }}
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ getCompletedSessionsCount() }}
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <Link :href="route('admin.manasik.create')"
                                    ...
                                    <tr v-for="session in sessions.data" :key="session.id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <Link :href="route('admin.manasik.show', session.id)"
                                                    class="text-blue-600 hover:text-blue-900">
                                                Detail
                                                </Link>
                                                <Link :href="route('admin.manasik.edit', session.id)"
                                ...
                                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                    <div>
                                        <p class="text-sm text-gray-700">
                                            Showing {{ sessions.from || 0 }} to {{ sessions.to || 0 }} of {{
                                            sessions.total }}
                                            results
                                        </p>
                                    </div>
