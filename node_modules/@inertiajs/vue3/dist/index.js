...
var Link = (0, import_vue7.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    const method = (0, import_vue7.computed)(
      () => (0, import_core6.isUrlMethodPair)(props.href) ? props.href.method : props.method.toLowerCase()
    );
    ...
    const mergeDataArray = (0, import_vue7.computed)(
      () => (0, import_core6.mergeDataIntoQueryString)(
        method.value,
        (0, import_core6.isUrlMethodPair)(props.href) ? props.href.url : props.href,
        props.data,
        props.queryStringArrayFormat
      )
    );
